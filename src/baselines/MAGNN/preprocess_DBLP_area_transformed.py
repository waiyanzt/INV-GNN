...
save_prefix = 'data/preprocessed/DBLP_preprocessed_area_transformed/'
num_ntypes = 4
...
expected_metapaths = [
    ...
    [(0, 1, 0), (0, 1, 2, 1, 0), (0, 3, 0)],
    [(2, 0, 2), (2, 0, 1, 0, 2), (2, 0, 1, 3, 1, 0, 2)],
    [(3, 1, 3), (3, 1, 0, 1, 3), (3, 1, 0, 2, 0, 1, 3)]
]
...
for metapath in [(0, 1, 0), (0, 2, 0), (0, 1, 3, 1, 0)]:
