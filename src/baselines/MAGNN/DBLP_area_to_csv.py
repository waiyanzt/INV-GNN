...
save_prefix = 'data/csv/DBLP_area/'
...
for _, row in paper_area.iterrows():
    ...
    adjM[idx1, idx2] = 1
    adjM[idx2, idx1] = 1
    edge_paper_area["src_id"].append(idx1)
    edge_paper_area["dst_id"].append(idx2)
    #edge_paper_area["label"].append(4)

    edge_area_paper["src_id"].append(idx2)
    edge_area_paper["dst_id"].append(idx1)
    #edge_area_paper["label"].append(5)
...
edge_paper_area.to_csv(save_prefix + "paper_area.csv", index=False)
...
edge_area_paper.to_csv(save_prefix + "area_paper.csv", index=False)
