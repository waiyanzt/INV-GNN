#!/usr/bin/env python3
"""SlotGAT entry point for joint IMDb link-prediction augmentation.

The model-independent md/ml training and evaluation protocol is shared with
the RGCN runner so graph variants, splits, negative candidates, checkpoint
selection, exact resume, metrics, and score exports cannot drift.
"""
...
def main() -> None:
    ...
    from run_IMDB_rgcn_lp_augmentation import main as shared_main
